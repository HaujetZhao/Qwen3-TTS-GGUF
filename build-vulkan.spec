...
#
# 打包 GUI 为可分发 exe: llama.cpp vulkan + onnxruntime-directml 版。
#
# 用法:
#   uv sync --extra dml
#   uv run pyinstaller build-vulkan.spec
#
# CUDA 版见 build-cuda.spec；两个 spec 分开写, 避免 build/ 缓存来回失效拖慢构建。
#
...
VARIANT = "vulkan"
LLAMA_ZIP = "llama-b10621-bin-win-vulkan-x64.zip"
