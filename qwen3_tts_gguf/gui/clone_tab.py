...
class CloneTab(ttkb.Frame):
    ...
    def _build_infer_group(self):
        ...
        # 默认任务文本：取自个人笔记的 16 句金句，每行一个独立单句，体量与单步 TTS 匹配
        self.task_text.insert("1.0",
                              "sonder 就是你突然意识到，身边的每一个人都过着与你一样真实的人生。\n"
                              "窗外风暴的喧嚣，恰恰让室内的温暖显得格外美好。\n"
                              "你以为你在做选择，其实你在一个已经被限定好的空间里移动。\n"
                              "说出来，本身就是一种能力。\n"
                              "你在上面想得再清楚，也不过是在一栋地基有问题的楼里装修。\n"
                              "人生不是用红头文件丈量的，而是用看见花开、听见雨声的瞬间拼凑的。\n"
                              "永远不要去美化那条你没有选择的道路。\n"
                              "昨日之深渊，今日之浅潭；路虽远，行则将至，事虽难，做则可成。\n"
                              "问题有多大，取决于你的世界有多大，茶杯里面的风暴在浴缸里面不值一提。\n"
                              "除了生病，你感受到的痛苦，都是你的价值观所带来的，并不真实存在。\n"
                              "万物都在涨价，唯有岁月在降价。\n"
                              "人生就像在泰坦尼克号上选座，不要总焦虑这个焦虑那个。\n"
                              "一个人如果不看书，他的价值观就由他身边所接触的人决定。\n"
                              "真正的珍惜，从来都不是供奉着，而是让它物尽其用。\n"
                              "你最容易被骗的时刻，就是想要立刻找到答案的时刻。\n"
                              "很多痛苦不是因为不够努力，而是因为排序错了。")
